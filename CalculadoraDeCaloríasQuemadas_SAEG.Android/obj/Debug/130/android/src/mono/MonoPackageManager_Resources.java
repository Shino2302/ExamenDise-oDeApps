...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "CalculadoraDeCaloríasQuemadas_SAEG.Android.dll" comes first in this list. */
		"CalculadoraDeCaloríasQuemadas_SAEG.Android.dll",
		"CalculadoraDeCaloríasQuemadas_SAEG.dll",
		"FormsViewGroup.dll",
